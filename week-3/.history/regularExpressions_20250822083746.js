...
const patterns = {
    ...
    email:/^([a-z\d\.-])@([a-z\d-]+)\.([a-z]{2,8})(\.[a-z]{2,8})?$/    //now the dot(.) has a \ before so that we can escape and use it as a regular . instead f its meaning in js regular expressions. Als
}
